...
@Component({
  selector: 'app-vende-prop',
  templateUrl: './vende-prop.component.html',
  styleUrls: ['./vende-prop.component.scss'],
})
export class VendePropComponent implements OnInit {
